        ...
        <table class="activity-data table" id="usuariosRegistrados">
          <thead class="table">
            <tr>
              ...
              <th class="data-title" scope="col">Contraseña</th>
        ...
        <form action="../controlador/accion/registrarUsuario.php" method="post">
          <div class="modal-body">
            <div class="container-fluid">
              ...
              <div style="padding:7px 0;" class="justify-content-center row">
                <div class="col-md-8"><input placeholder="Contraseña" type="password" class="form-control"
                    name="contrasena"></div>
              </div>
              <div style="padding:7px 0;" class="justify-content-center row">
        ...
        <form action="../controlador/accion/editarUsuario.php" method="post">
          <div class="modal-body">
            <div class="container-fluid">
              ...
              <div style="padding:7px 0;" class="justify-content-center row">
                <div class="rol col-md-8">
                  <select class="programaSelect" name="programa">
                    <option disabled selected>Programa</option>
                  </select>
                </div>
              </div>
