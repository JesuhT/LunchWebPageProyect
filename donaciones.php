  ...
  <main>
    ...
    <div class="container-total">
      ...
      <div class="container">
        ...
        <section>
          <div class="container-cards">
            <article>
              <div class="card">
                  <img src="assets/img/people/pic-2.jpg" alt="perfil" />
                <div class="información">
                  <p class="text">NOMBRE APELLIDO</p>
                  <p class="text-b">Programa</p>
                  <p class="text-c">Está donando su almuerzo</p>
                </div>
                <p class="interesado">Interesado</p>
                <button>></button>
                <p class="tiempo_donacion">30 min</p>
              </div>
            </article>
            <article>
              <div class="card">
                  <img src="assets/img/people/pic-1.jpg" alt="perfil" />
                <div class="información">
                  <p class="text">NOMBRE APELLIDO</p>
                  <p class="text-b">Programa</p>
                  <p class="text-c">Está donando su almuerzo</p>
      ...
      <div class="container_confirmacion">
        <div class="titulo"><h1>¡Ayuda al que lo necesita!</h1></div>
